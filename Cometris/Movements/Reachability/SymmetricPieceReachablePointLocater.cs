...
namespace Cometris.Movements.Reachability
{
    ...
    {
        public static TBitBoard LocateReachablePointsFirstStep(TBitBoard spawn, TBitBoard mobilityBoard) => LocateNewReachablePoints(spawn & mobilityBoard, mobilityBoard);
