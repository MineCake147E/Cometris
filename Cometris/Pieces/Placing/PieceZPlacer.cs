...
namespace Cometris.Pieces.Placing
{
        ...
        where TBitBoard : unmanaged, IOperableBitBoard<TBitBoard, ushort>
    {
        ...
        {
            var lline = (ushort)(0xC000_C000u >> x);
        ...
        {
            var lline = (ushort)(0x0001_0001u >> x);
            var mline = (ushort)(0x8001_8001u >> x);
            var uline = (ushort)(0x8000u >> x);
            return TBitBoard.CreateThreeAdjacentLines(y, lline, mline, uline);
        }
        public static TBitBoard Place(Angle angle, int x, int y) => PiecePlacerImplementationUtils.Place<TBitBoard, PieceZPlacer<TBitBoard>>(angle, x, y);
    }
}
