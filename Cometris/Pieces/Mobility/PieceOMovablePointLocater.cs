...
{
    public readonly struct PieceOMovablePointLocater<TBitBoard> : ISymmetricPieceMovablePointLocater<TBitBoard> where TBitBoard : unmanaged, IOperableBitBoard<TBitBoard, ushort>
    {
